...
window.addEventListener('scroll', () => {
    if (window.scrollY > 50) {
        navbar.style.background = 'rgba(10, 9, 12, 0.92)';
        navbar.style.boxShadow = '0 2px 30px rgba(0, 0, 0, 0.35)';
    } else {
        navbar.style.background = 'rgba(10, 9, 12, 0.75)';
...
console.log('Portfolio website loaded successfully! (now with a persistent 3D scene)');